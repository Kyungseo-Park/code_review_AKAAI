...
<div class="container-fluid pt-5">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">교육/세미나 업데이트</h1>
    </div>
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.education.update.form') }}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" id="id" value="{{ $education->id }}">
                        <div class="form-group">
                            <label for="title" class="label-title">제목</label>
                            <input type="text" class="form-control" id="title" name="title" aria-describedby="titleHelp" value="{{ $education->title }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ $education->subtitle }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="r_thumbnail" name="r_thumbnail" value="{{ $education->thumbnail }}">
                            <div class="invalid-feedback text-danger">
                                * 필수값
                            </div>
                            <div class="row">
                                <img src="{{ asset($education->thumbnail) }}" alt="750x500 sample image" width="300px"
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="r_file" id="r_file" value="{{ $education->uploadfile }}">
                            <input type="hidden" name="r_filename" id="r_filename" value="{{ $education->filename }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="recruitment_personnel" id="recruitment_personnel" minlength="0" value="{{ $education->recruitment_personnel }}"> 
                            <div class="invalid-feedback text-danger">
                                * 필수값
                            </div>
                        </div>

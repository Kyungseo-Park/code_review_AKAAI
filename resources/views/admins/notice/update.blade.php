    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.notice.update.form') }}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" aria-describedby="titleHelp" value="{{ $notice->title }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="r_filename" value="{{ $notice->filename }}">
                            <input type="hidden" name="r_file" value="{{ $notice->uploadfile }}">
                            <div class="invalid-feedback text-danger">
                                * 필수값
                            </div>
                        </div>
